...
export default function About() {
  ...
  const values = [
    {
      icon: Lightbulb,
      titleKey: "about.innovation" as const,
      descKey: "about.innovationDesc" as const,
    },
    {
      icon: Target,
      titleKey: "about.excellence" as const,
      descKey: "about.excellenceDesc" as const,
    },
    {
      icon: Heart,
      titleKey: "about.passion" as const,
      descKey: "about.passionDesc" as const,
    },
    {
      icon: Zap,
      titleKey: "about.efficiency" as const,
      descKey: "about.efficiencyDesc" as const,
    },
  ];

  const whyItems = [
    {
      titleKey: "about.premiumQuality" as const,
      descKey: "about.premiumQualityDesc" as const,
    },
    {
      titleKey: "about.expertDesign" as const,
      descKey: "about.expertDesignDesc" as const,
    },
    {
      titleKey: "about.professionalInstall" as const,
      descKey: "about.professionalInstallDesc" as const,
    },
    {
      titleKey: "about.sustainable" as const,
      descKey: "about.sustainableDesc" as const,
    },
    {
      titleKey: "about.support" as const,
      descKey: "about.supportDesc" as const,
    },
    {
      titleKey: "about.trackRecord" as const,
      descKey: "about.trackRecordDesc" as const,
    },
  ];
    ...
    <div className="w-full" dir={dir}>
      ...
      <section className="relative py-20 sm:py-28 bg-foreground text-background border-b-2 border-foreground">
        <div className="container">
          <h1 className="heading-xl text-background mb-4">
            {t("about.title")}
          </h1>
        ...
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className={language === "ar" ? "order-1" : "order-2"}>
              <div className="relative w-full aspect-video border-2 border-foreground overflow-hidden group">
                <img
                  src="img\QUbe22.png"
            ...
            {values.map((value, idx) => {
              ...
              return (
                ...
                >
                  <Icon
                    size={40}
                    className="mx-auto mb-4 text-accent group-hover:text-background transition-colors"
                  />
                  <h3 className="heading-sm text-foreground group-hover:text-background mb-3 transition-colors">
                    {t(value.titleKey)}
                  </h3>
                  <p className="text-sm text-foreground group-hover:text-background opacity-80 transition-colors">
                    {t(value.descKey)}
                  </p>
                </div>
              );
