        ...
        <form action="{{ route('admin.faqs.store') }}" method="POST">
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="question_ar" class="form-control @error('question_ar') is-invalid @enderror" value="{{ old('question_ar') }}" dir="rtl" required>
            ...
            <div class="row g-4 mb-4">
                <div class="col-md-6">
                    ...
                    <textarea name="answer_en" rows="5" class="form-control @error('answer_en') is-invalid @enderror" required>{{ old('answer_en') }}</textarea>
                ...
                <div class="col-md-6">
                    ...
                    <textarea name="answer_ar" rows="5" class="form-control @error('answer_ar') is-invalid @enderror" dir="rtl" required>{{ old('answer_ar') }}</textarea>
